...
ISR(TIMER1_OVF_vect)
{
	...
	TCNT1H = 0xF8;		//reload counter high value, for exactly 1 second at prescale:1024 & Frequency 14.745600MHz
	...
	PORTJ = 2*PORTJ + 1;// Since Bar graph must have inputs as 0x01,0x03,0x07,0x0F,0x1F,0x3F,0x7F & 0xFF
