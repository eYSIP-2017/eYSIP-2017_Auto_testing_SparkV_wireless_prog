...
void lcd_display_number(int number)
{
	...
	digit_tens=digit_tens+48;	                //Step 1: extract the ten's digit using the division operator and convert to its ascii equivalent
	...
	digit_units=digit_units+48;		//Step 3: extract the unit's digit using the modulo operator and convert to its ascii equivalent
