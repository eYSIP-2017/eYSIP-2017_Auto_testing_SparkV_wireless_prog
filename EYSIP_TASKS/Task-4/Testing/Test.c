...
void test_main_1() // The renamed main function of the submission is UNIT tested inside this UNIT test function
{
...
void test_buzzer_on() // The Buzzer_on function is UNIT tested inside this UNIT test function
{
...
void test_buzzer_off() The Buzzer_off function is UNIT tested inside this UNIT test function
{
...
int main(void) // Main function of the unit test where the various tests are run.
{
UNITY_BEGIN();
